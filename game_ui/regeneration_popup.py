...
class RegenerationPopup:
    ...
    def __init__(
        ...
        self.button_auto_rect = pygame.Rect(
            self.button_auto_x, self.button_y, self.button_width, self.button_height
        )
        self.button_custom_rect = pygame.Rect(
            self.button_custom_x, self.button_y, self.button_width, self.button_height
        )
    ...
    def draw(self):
        ...
        pygame.draw.rect(
            self.screen, auto_color, self.button_auto_rect, border_radius=12
        )
        pygame.draw.rect(
            self.screen, self.border_color, self.button_auto_rect, 2, border_radius=12
        )
        ...
        pygame.draw.rect(
            self.screen, custom_color, self.button_custom_rect, border_radius=12
        )
        pygame.draw.rect(
            self.screen, self.border_color, self.button_custom_rect, 2, border_radius=12
        )
