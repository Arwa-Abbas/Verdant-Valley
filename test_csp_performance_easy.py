#!/usr/bin/env python
"""
Quick test of CSP solver performance with easier settings
"""
...
def test_csp_performance_easy():
    """Test CSP solver with easier crop counts"""
    ...
    # Test with MUCH easier crop counts
    test_counts = {
        CROP_WHEAT: 1,
        CROP_SUNFLOWER: 1,
        CROP_CORN: 2,
...
if __name__ == "__main__":
    success = test_csp_performance_easy()
